...
const InstaContentAdmin11 = memo(
  ({ imageRemovebgPreview11, instagramImageForPosts }) => {
    return (
      <div className="insta-instacontentadmin3">
        <div className="insta-frame-parent5">
          <div className="insta-digiitalhighway-logo-parent1">
            <DigiitalHighwayLogo
              ...
              propLeft1="9.03%"
            />
            <div className="insta-div36">디지털지름길_공식</div>
          </div>
          ...
          />
          <div className="insta-underpicture4">
            <img
              className="insta-mdiheart-icon4"
              alt=""
              src="/appguide/instagram/mdiheart.svg"
            />
            <img
              className="insta-iconamooncomment4"
              alt=""
              src="/appguide/instagram/iconamooncomment.svg"
            />
            <div className="insta-comment4">댓글 3개</div>
            <div className="insta-likes4">좋아요 21개</div>
          </div>
          <div className="insta-content5">
            <p className="insta-blank-line">{`반갑습니다 ! “디지털지름길” 서비스가 2024년 6월 시작합니다! 저희 서비스는 “디지털 환경의 보다 더 빠르고 쉬운 적응"을 위해 노력하는 서비스입니다. `}</p>
            <p className="insta-blank-line">
              어디서도 가르쳐주지 않은 각종 휴대폰 어플리케이션의 사용법,
              스마트기기들의 사용법을 여기서 차근 차근 알려줄께요!
            </p>
            <p className="insta-blank-line">&nbsp;</p>
            <p className="insta-blank-line">
