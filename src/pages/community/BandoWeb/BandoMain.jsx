...
//     const shouldShowExpandButton = comment._doc.commentContent.split('\n').length > 3;
...
//           <div className={`bandodiv24 ${isExpanded ? "expanded" : "collapsed"}`}>
//             {comment._doc.commentContent}
//           </div>
//           {shouldShowExpandButton && (
//             <button 
//               className="expand-button" 
//               onClick={() => toggleExpandComments(comment._id)}
//             >
//               {isExpanded ? "접기" : "더보기"}
//             </button>
//           )}
