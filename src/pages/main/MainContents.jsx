  ...
  return (
    <div className="maincontents">
      ...
      <section className="maincontentsad">
        ...
        <img className="icon never" onClick={()=>{categoryClick("never")}} alt="" src="main/never.png" />
        ...
        <img className="icon button6" onClick={()=>{categoryClick("gov25")}} alt="" src="main/25@3x.png" />
